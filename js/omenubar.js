...
class MenubarNavigation {
  constructor(domNode) {
    ...
    this.updateContent(this.currentUrl, false);
  ...
  updateContent(linkURL, moveFocus) {
    var pathNode;
  ...
  redirect(linkURL) {
    console.log(linkURL, window.location.href);
  ...
  getIdFromAriaLabel(node) {
    ...
    if (id) {
      id = id.trim().toLowerCase().replaceAll(" ", "-").replaceAll("/", "-");
    }
    return id;
  }
